...
const activityLogs = [
  ...
  },
  {
    ...
    details: "",
    result: "Success",
    timestamp: "Apr 29, 2024 10:20 AM"
  },
  {
    id: 6,
    user: {
    ...
    details: "",
    result: "Success",
    timestamp: "Apr 29, 2024 10:10 AM"
  },
]
      ...
      <div className="flex-1 overflow-auto p-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="relative" ref={dateDropdownRef}>
            ...
            {isDateDropdownOpen && (
              <div className="absolute top-full right-0 mt-2 w-56 bg-[#0c0926]/95 border border-white/10 rounded-lg shadow-lg z-10">
                {["Last 7 Days", "Last 30 Days", "Last 3 Months", "Last 6 Months", "Last Year", "All Time"].map((range) => (
                  <button
                    key={range}
          ...
          <div>
            {paginatedLogs.map((log) => (
              ...
              >
                ...
                {/* Timestamp */}
                <div className="w-[15%] text-sm text-white/50 text-right">{log.timestamp}</div>
              </div>
            ))}
          </div>
