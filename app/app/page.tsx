...
export default function Home() {
  ...
  const [open, setOpen] = useState(false) //menu for phone
  ...
  return (
    <div className="min-h-screen text-white" style={{
      ...
      <nav className="border-b border-white/10">
        <div className="w-full px-4 md:px-6 py-5 flex items-center justify-between">
          ...
          <div className="md:hidden">
            <button className="text-white" onClick={handClick}>Menu</button>
          </div>
        </div>
        ...
        {open && (
          <div className="md:hidden flex flex-col gap-4 px-4 pb-4 text-sm">
            ...
            <Link href="/placement/dashboard" onClick={close}>ATS Score</Link>
      ...
      {/* Hero Section */}
      <section id="home" className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24">
