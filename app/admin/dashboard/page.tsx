    ...
    <>
      ...
      <header className="h-20 px-8 flex items-center justify-between border-b border-white/5 bg-[#16103a]/30 backdrop-blur">
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/90 shadow-[0_10px_40px_-18px_rgba(76,106,255,0.6)] hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/50">
              Admin Panel
            ...
            <DropdownMenuContent
              align="end"
              sideOffset={12}
              className="w-64 rounded-2xl border border-white/10 bg-[#0c0926]/95 text-white shadow-2xl shadow-blue-900/40 backdrop-blur-lg"
            >
              <DropdownMenuLabel className="text-white/90">Admin Panel</DropdownMenuLabel>
              <DropdownMenuSeparator className="bg-white/10" />
              <DropdownMenuItem className="gap-2 text-white/85 hover:bg-white/10 focus:bg-white/10">
                <User2 size={16} className="text-blue-300" />
              ...
              <DropdownMenuItem className="gap-2 text-white/85 hover:bg-white/10 focus:bg-white/10">
                ...
                <div className="flex flex-col leading-tight">
                  ...
                  <span className="text-[11px] text-white/50">Secure your account</span>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem className="gap-2 text-white/85 hover:bg-white/10 focus:bg-white/10">
              ...
              <DropdownMenuSeparator className="bg-white/10" />
              <DropdownMenuItem className="gap-2 text-red-300 hover:bg-red-500/10 focus:bg-red-500/10">
                <LogOut size={16} />
